...
const EditCarForm = ({ carToEdit, onSuccess, onClose }) => {
    ...
    const [imagePreview, setImagePreview] = useState(carToEdit?.imageUrl || null);
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <label htmlFor="car-image-edit" className="cursor-pointer mt-2 inline-flex items-center px-3 py-1 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
